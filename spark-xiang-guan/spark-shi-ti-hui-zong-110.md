...
#### 试题一：热点搜索词滑动统计，每隔10秒钟，统计最近60秒钟的搜索词的搜索频次，并打印出排名最靠前的3个搜索词以及出现次数

考察点：sparkStreaming窗口函数，`reduceByKeyAndWindow`
...
object WindowHotWord {  
  def main(args: Array[String]): Unit = {  
    ...
    val searchLogsDStream = ssc.socketTextStream("test", 9999)  
